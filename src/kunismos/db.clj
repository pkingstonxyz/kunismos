...
(defn get-entries [userid]
  (jdbc/execute! ds [(format "select * from kunismos where user_id=%d order by date desc limit 10" userid)] {:return-keys true :builder-fn rs/as-unqualified-lower-maps}))
